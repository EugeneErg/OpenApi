...
return (static function (): array {
    ...
    $tree = new Schemas\Object\Schema(
        properties: new Schemas\Object\Properties(
            ...
            nothing: new Schemas\Object\Property(schema: new Schemas\Null\Schema(description: 'Always null.')),
            mixed: new Schemas\Object\Property(
                schema: new Schemas\Untyped\EnumSchema(new Schemas\Untyped\Values('auto', 0), nullable: true),
            ),
        ),
        required: new Schemas\String\Strings('x-generated'),
        patternProperties: Schemas\Object\PatternProperties::fromArray(['^x-' => new Schemas\String\Schema()]),
        propertyNames: new Schemas\String\Schema(pattern: '^[a-z-]+$'),
        dependentRequired: new Schemas\Object\DependentRequired(kind: new Schemas\String\Strings('root')),
        dependentSchemas: new Schemas\Untyped\Schemas(
            kind: new Schemas\Object\Schema(declareType: false, minProperties: 1),
        ),
        minProperties: 1,
        maxProperties: 20,
    ...
    $tuple = new Schemas\Array\Schema(
        ...
        maxItems: 5,
        uniqueItems: true,
        prefixItems: new Schemas\Untyped\Schemas($street, $measurement),
    ...
    $attachment = new Schemas\String\Schema(
        ...
        contentSchema: new Schemas\Object\Schema(
            properties: new Schemas\Object\Properties(
                name: new Schemas\Object\Property(schema: new Schemas\String\Schema(), required: true),
            ),
        ),
    );
    ...
    $card = new Schemas\Object\Schema(
        ...
        if: new Schemas\Object\Schema(
            properties: new Schemas\Object\Properties(
                kind: new Schemas\Object\Property(schema: new Schemas\String\EnumSchema(
                    new Schemas\String\Strings('credit'),
                )),
            ),
        ),
        then: new Schemas\Object\Schema(
            properties: new Schemas\Object\Properties(
                limit: new Schemas\Object\Property(
        ...
        else: new Schemas\Object\Schema(declareType: false, not: new Schemas\Untyped\Schema()),
    ...
    $payment = new Schemas\Untyped\Schema(
        ...
        discriminator: new Schemas\Abstract\Discriminator(
            ...
            extensions: new Extensions(closed: true),
        ),
        deprecated: true,
    );
    ...
    $mtls = new SecuritySchemes\MutualTlsSecurityScheme(description: 'Client certificate.');
    ...
    $listPayments = new Paths\Operation(
        responses: Responses::fromArray(
            [
                ...
                '4XX' => new Reference($notFound, summary: 'Client error', description: 'Anything 4xx.'),
                'default' => $notFound,
            ],
        ...
        security: new Securities(
            ...
            new Securities\SecuritySchemes(new Securities\Role($bearer, 'admin')),
        ...
        callbacks: Components\Callbacks::fromArray([
            'onPaid' => PathItems::fromArray(
                ...
                new Extensions(retry: Schemas\Object\OpenapiObject::fromArray(['attempts' => 3])),
            ),
        ]),
    ...
    return ['kitchen-sink-31.json' => new Openapi(
        info: new Info(
            title: 'Everything the package can build',
            version: '1.0.0',
            summary: 'A single document exercising every supported field.',
            description: 'Built by tests/Cases/BuilderTest/Objects/kitchen-sink-31.php.',
        ...
        webhooks: new PathItems(paymentReceived: $ping),
        extensions: new Extensions(...['spec-filename' => 'kitchen-sink-31.json']),
    )];
})();
